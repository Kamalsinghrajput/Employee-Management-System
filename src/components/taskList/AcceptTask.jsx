const AcceptTask = () => {
  return (
    ...
    <div className="flex justify-between mt-2 mx-3" > 
        <button className="bg-green-500 py-1 px-3 text-sm m-2 rounded">Make as completed</button>
        <button className="bg-red-500 py-1 px-3 text-sm m-2 rounded">Mark as failed</button>
    </div>
